...
Welcome! I am your AI coding agent. This file follows the [AGENTS.md](https://agents.md/) standard to provide me with the context and instructions I need to work on the **NextJS Shadcn (Next.js & Tailwind Setup)** project effectively.

## Project Overview
This project is a boilerplate and development environment optimized for **Next.js 15** and **Tailwind CSS**. It is designed to provide a clean, high-performance starting point for modern web applications, transitioning from previous frameworks to a more robust Next.js-based architecture.

### Core Objectives
- **Next.js 15 Integration**: Utilizing the latest App Router and Server Components features.
- **Tailwind CSS Styling**: implementing a responsive and modern design system using Tailwind CSS.
- **Shadcn UI Integration**: Leveraging high-quality, accessible UI components.
- **Framework Transition**: Successfully migrating and adapting logic from previous environments to the Next.js ecosystem.
